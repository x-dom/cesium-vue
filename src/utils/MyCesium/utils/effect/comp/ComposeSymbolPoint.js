...
// export class ComposeSymbolPoint {
 ...
 * 组合符号标记点
 */
class ComposeSymbolPoint {
    constructor(viewer, options) {
        this.options = {...this.options,...options};//自定义属性
        this.viewer = viewer;
    ...
    createGroundCircle() {
        ...
        var primitive = this.collection.add(new Cesium.Primitive({
 ...
 * 圆形封闭墙
 */
class CloseWallOfCircleGeometry {
    constructor(options) {
        options = options || {};
...
export {ComposeSymbolPoint, CloseWallOfCircleGeometry};